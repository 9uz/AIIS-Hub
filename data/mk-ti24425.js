...
window.MK.push({
  ...
  basisBerkas: 'berkas/ti24425/',

  pengampu: [
    { nama: 'Gus Nanang Syaifuddiin, S.Kom., M.Kom.', peran: 'Dosen Pengampu' },
  ],

  sorotan: '<strong>Mata kuliah teori, 3 sks.</strong> Pembelajaran memakai metode <em>case method</em>: ceramah interaktif, diskusi kasus, dan latihan terbimbing di kelas. Kegiatan berbasis komputer berlangsung di luar jam tatap muka sebagai penugasan terstruktur dan bersifat opsional.',
